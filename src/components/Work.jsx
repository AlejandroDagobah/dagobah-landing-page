        ...
        <div id="work">
            ...
            <div className="flex my-6 flex-wrap	sm:flex-nowrap">
                <div className="flex absolute left-px sm:left-0 sm:relative max-w-[100%] overflow-x-auto sm:overflow-x-hidden sm:flex-col sm:max-w-[250px]">
                    <div id="navTabProj" className={`absolute hidden sm:block sm:w-[2px] sm:h-[40px] bg-aleRed rounded-lg transition-all ease-in-out duration-150 delay-200 translate-y-0`}></div>
                    {buttons}
                </div>

                <div className="flex-col basis-full sm:basis-3/4 pl-4 pt-24 md:pt-0">
