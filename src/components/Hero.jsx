        ...
        <div className="flex-col-reverse flex sm:flex-row justify-between">
            ...
            <div className="flex flex-col justify-center items-center sm:items-start">
                ...
                <h1 className="font-crimsonPro font-bold text-center sm:text-start">
                    <span className="text-6xl" id="ale">Alejandro.</span>
            ...
            <object data="img/aledevelops-illustration.svg" id="ale-illustration" className="ale-vector w-3/4 md:h-[500px]"> </object>                {/**/}
            </div>
        </div>
    )
